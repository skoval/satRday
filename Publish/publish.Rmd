...
I can preview the site with the `serve_site` function. Here is what the new theme looks like:
...
1. When you are ready to publish your site, you can use the `build_site(local = FALSE)` function, which knits the Rmd files and runs Hugo to prepare your site for publication.
...
- `Disqus` is a popular comment service provider

...
- *Answer:* Not exactly. We have a logistic relationship, but remember that we are looking at win expectations over the long-term and not individual game outcomes.
...
- Using data from the last season of the NBA we showed how to fit and evaluate the model for a given sport
